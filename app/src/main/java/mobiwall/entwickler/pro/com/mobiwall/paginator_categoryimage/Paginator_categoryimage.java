...
public class Paginator_categoryimage {
    ...
    public Paginator_categoryimage(Context c, PullToLoadView pullToLoadView, String string) {
        ...
        adapter = new MyRecyclerAdapter(c, new ArrayList<mobiwall.entwickler.pro.com.mobiwall.paginator.Grid_model>());
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                mobiwall.entwickler.pro.com.mobiwall.paginator.Grid_model grid_model = new mobiwall.entwickler.pro.com.mobiwall.paginator.Grid_model();
