...
public class Paginator_hot {
        ...
        public Paginator_hot(Context c, PullToLoadView pullToLoadView) {
            this.c = c;
        ...
        public void LoadData(final int page) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    String URL="http://www.charmhdwallpapers.com/wallpaper/imagelist?page_size=20&last_item_id=0&device_uid=c699fde86c24b1c&category_id=&category_type=Hot&color_code=&count=0%22";
